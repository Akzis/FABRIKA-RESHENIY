...
export interface ApiChallengeLevelChallengeLevel
  extends Struct.CollectionTypeSchema {
  collectionName: 'challenge_levels';
  info: {
    description: '\u0423\u0440\u043E\u0432\u043D\u0438 \u0441\u043B\u043E\u0436\u043D\u043E\u0441\u0442\u0438 \u0447\u0435\u043B\u043B\u0435\u043D\u0434\u0436\u0435\u0439';
    displayName: 'Challenge level';
    pluralName: 'challenge-levels';
    singularName: 'challenge-level';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    image: Schema.Attribute.Media<'images'>;
    key: Schema.Attribute.Enumeration<['lite', 'med', 'hard']> &
      Schema.Attribute.Required &
      Schema.Attribute.Unique;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::challenge-level.challenge-level'
    > &
      Schema.Attribute.Private;
    ...
    publishedAt: Schema.Attribute.DateTime;
    rows: Schema.Attribute.Component<'shared.row', true>;
...
export interface ApiRoleCardRoleCard extends Struct.CollectionTypeSchema {
  collectionName: 'role_cards';
  info: {
    description: '\u041A\u0430\u0440\u0442\u043E\u0447\u043A\u0438 \u0440\u043E\u043B\u0435\u0439 \u043F\u043B\u0430\u0442\u0444\u043E\u0440\u043C\u044B';
    displayName: 'Role card';
    pluralName: 'role-cards';
    singularName: 'role-card';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    image: Schema.Attribute.Media<'images'>;
    key: Schema.Attribute.Enumeration<['member', 'pm']> &
      Schema.Attribute.Required &
      Schema.Attribute.Unique;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::role-card.role-card'
    > &
      Schema.Attribute.Private;
    order: Schema.Attribute.Integer & Schema.Attribute.DefaultTo<1>;
    publishedAt: Schema.Attribute.DateTime;
...
export interface PluginUsersPermissionsUser
  ...
  attributes: {
    ...
    challengesClosed: Schema.Attribute.Integer &
      Schema.Attribute.SetMinMax<
        {
          min: 0;
        },
    ...
    teamCupCurrent: Schema.Attribute.Integer &
      ...
      > &
      Schema.Attribute.DefaultTo<0>;
    teamCupPlace: Schema.Attribute.Integer &
      Schema.Attribute.SetMinMax<
        {
          min: 0;
        },
      ...
      > &
      Schema.Attribute.DefaultTo<0>;
    teamCupTotal: Schema.Attribute.Integer &
      Schema.Attribute.SetMinMax<
        {
          min: 1;
        },
    ...
    teamRole: Schema.Attribute.Enumeration<['member', 'pm']> &
